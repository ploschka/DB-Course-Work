...
final class Version20221216063026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE department DROP CHECK CHK_DepStrLength, ADD CONSTRAINT CHK_DepStrLength CHECK (LENGTH(name)>=5)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE department DROP CHECK CHK_DepStrLength');
        ...
        $this->addSql('ALTER TABLE department ADD CONSTRAINT CHK_DepStrLength CHECK (LENGTH(name)>=5 AND LENGTH(chief_name)>=5)');
