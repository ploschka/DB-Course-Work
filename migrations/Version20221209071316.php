...
final class Version20221209071316 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE department CHANGE name name VARCHAR(255) NOT NULL, CHANGE chief_name chief_name VARCHAR(255) NOT NULL, DROP CONSTRAINT CHK_DepStrLength');
        $this->addSql('ALTER TABLE worker CHANGE name name VARCHAR(255) NOT NULL, DROP CONSTRAINT CHK_WorkerStrLength');
        $this->addSql('ALTER TABLE work_clothing CHANGE type type VARCHAR(255) NOT NULL, DROP CONSTRAINT CHK_WorkClothStrLength');
        $this->addSql('ALTER TABLE post CHANGE name name VARCHAR(255) NOT NULL, DROP CONSTRAINT CHK_PostStrLength');
    }
}
